...
describe('Breadcrumb directive with dynamic parent conf', function() {
    ...
    it('should use the custom breadcrumb\'s parent property referencing a variable of the scope', inject(
        function() {
            goToState('D.E.H');

            controller('ReturnCCtrl', {
                '$scope' : scope
            });
            compile(scope);
    ...
    it('should ignore the custom breadcrumb\'s parent property if it is a function returning undefined', inject(
        function() {
            goToState('D.E.H');
